...
# ---------------------------- GENERATE WORD ------------------------------- #
try:
    data_df = pandas.read_csv("./src/data/words_to_learn.csv")
except FileNotFoundError:
    original_data = pandas.read_csv("./src/data/french_words.csv")
...
def is_known():
    ...
    data.to_csv("./src/data/words_to_learn.csv", index=False)
    next_card()
...
card_back_img = PhotoImage(file="./src/images/card_back.png")
